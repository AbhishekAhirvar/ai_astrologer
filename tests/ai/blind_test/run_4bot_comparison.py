...
async def run_4bot_comparison(num_subjects: int = 2, question_idx: int = None):
    ...
    print("\n" + "=" * 80)
    print("🔮 4-BOT BLIND TEST COMPARISON")
    print("=" * 80)
    ...
    print(f"Total API calls: {num_subjects * 6 * 4} (subjects × questions × bots)")
    print("\n" + "=" * 80)
    ...
    for i, (system, mode) in enumerate([
        ...
        if i < 4:
            print(f"\n⏸️  Pausing 5 seconds before next bot...")
            await asyncio.sleep(5)
    
    print("\n" + "=" * 80)
    print("✅ 4-BOT COMPARISON COMPLETE")
    print("=" * 80)
    ...
    try:
        ...
        if len(prediction_files) == 4:
            ...
            print(f"\n✅ Combined HTML report: {output_path}")
        else:
            print(f"\n⚠️  Could not generate combined report (found {len(prediction_files)}/4 bot files)")
    except Exception as e:
        print(f"\n⚠️  Error generating combined report: {e}")
